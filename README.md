...
local machine with Jupyter notebook  
<br>
For a deeper understanding, you can access the course [Mesa tutorial](https://www.complexityexplorer.org/courses/172-agent-based-models-with-python-an-introduction-to-mesa/segments/17209)
